...
*   **Game Source Mining:** Automatically creates a directory mirroring the game's pak file but with all files already extracted (BBS_ as readable text, COL_ as .pac)
